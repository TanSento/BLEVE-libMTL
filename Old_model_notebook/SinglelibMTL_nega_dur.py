...
def main(params):
    print(params)
    X_train_torch, X_test_torch, target_train, target_test, quantile = get_data(mode='single', task_name='nega_dur')

    data_train = BLEVEDatasetSingle(X_train_torch, target_train, task_name='nega_dur')
    data_test = BLEVEDatasetSingle(X_test_torch, target_test, task_name ='nega_dur')
