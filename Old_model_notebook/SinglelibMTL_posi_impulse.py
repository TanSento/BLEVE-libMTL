...
def main(params):
    print(params)
    X_train_torch, X_test_torch, target_train, target_test, quantile = get_data(mode='single', task_name='posi_impulse')

    data_train = BLEVEDatasetSingle(X_train_torch, target_train, 'posi_impulse')
    data_test = BLEVEDatasetSingle(X_test_torch, target_test, 'posi_impulse')
    ...
    num_out_channels = {'posi_impulse': 1}
    ...
    BLEVENet.train(train_loader, test_loader, 50, mode = 'single', name = 'posi_impulse')
